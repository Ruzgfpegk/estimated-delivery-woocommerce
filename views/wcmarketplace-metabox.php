...
?>
		<tr>
			...
			<td>
				<label>
					<input type="checkbox" value="1" name="_edw_overwrite" <?= get_post_meta( $product_id, '_edw_overwrite', true ) === '1' ? 'checked="checked"' : '' ?>/>
				</label>
			</td>
		</tr>
<?php
...
?>
		<tr>
			...
			<td>
				<label>
					<input type="number" min="0" max="99999" name="_edw_days" value="<?= get_post_meta( $product_id, '_edw_days', true ) ?>"/>
				</label>
			</td>
		</tr>
		<tr>
			...
			<td>
				<label>
					<input type="number" min="0" max="99999" name="_edw_max_days" value="<?= get_post_meta( $product_id, '_edw_max_days', true ) ?>"/>
				</label>
			</td>
		</tr>
		<tr>
			...
			<td>
				<label>
					<input type="number" min="0" max="99999" name="_edw_days_outstock" value="<?= get_post_meta( $product_id, '_edw_days_outstock', true ) ?>"/>
				</label>
			</td>
		</tr>
		<tr>
			...
			<td>
				<label>
					<input type="number" min="0" max="99999" name="_edw_max_days_outstock" value="<?= get_post_meta( $product_id, '_edw_max_days_outstock', true ) ?>"/>
				</label>
			</td>
		</tr>
		<tr>
			...
			<td>
				<label>
					<input type="number" min="0" max="99999" name="_edw_days_backorders" value="<?= get_post_meta( $product_id, '_edw_days_backorders', true ) ?>"/>
				</label>
			</td>
		</tr>
		<tr>
			...
			<td>
				<label>
					<input type="number" min="0" max="99999" name="_edw_max_days_backorders" value="<?= get_post_meta( $product_id, '_edw_max_days_backorders', true ) ?>"/>
				</label>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<label>
					<input type="text" name="_edw_mode_custom" value="<?= get_post_meta( $product_id, '_edw_mode_custom', true ) ?>"/>
				</label>
			</td>
		</tr>
		<tr>
